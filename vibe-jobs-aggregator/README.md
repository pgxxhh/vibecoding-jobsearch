...
> 📘 **Riot Games 示例**：若要快速验证 Riot Games Careers 的抓取，可参考 [`docs/crawler-riotgames-setup.md`](docs/crawler-riotgames-setup.md) 中的 SQL 样例，依次配置解析模板、蓝图以及 `job_data_source`。
