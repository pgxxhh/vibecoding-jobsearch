...
public class JobDataSourceEntity {
    ...
    @Column(name = "crawler_blueprint_code", length = 128)
    private String crawlerBlueprintCode;
    ...
    public void setCrawlerBlueprintCode(String crawlerBlueprintCode) {
        this.crawlerBlueprintCode = crawlerBlueprintCode;
    }
