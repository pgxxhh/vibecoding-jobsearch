...
const translations: Translations = {
  zh: {
    ...
    'header.nav.findJobs': '找工作',
    'header.nav.companies': '公司',
    'header.nav.salaries': '薪资',
    'header.signIn': '登录',
    'language.zh': '中文',
    'language.en': 'English',
    ...
    'hero.badge': '每日上新',
    'hero.title': '发现下一份',
    'hero.titleAccent': '令人心动的职位',
    'hero.subtitle': '使用智能筛选快速锁定适合你的机会。',
    'hero.quickFilters.title': '热门方向',
    'hero.quickFilters.engineering': '工程',
    'hero.quickFilters.design': '设计',
    'hero.quickFilters.product': '产品',
    'hero.quickFilters.sales': '销售',
    ...
    'actions.reset': '重置',
    'actions.search': '搜索',
    'actions.quickApply': '快速申请',
    'actions.saveJob': '收藏职位',
    'actions.retry': '重试',
  ...
  en: {
    ...
    'header.nav.findJobs': 'Find Jobs',
    'header.nav.companies': 'Companies',
    'header.nav.salaries': 'Salaries',
    ...
    'hero.titleAccent': 'delightful gig',
    'hero.subtitle': 'Use precise filters to surface roles that match your flow.',
    'hero.quickFilters.title': 'Quick filters',
    'hero.quickFilters.engineering': 'Engineering',
    'hero.quickFilters.design': 'Design',
    'hero.quickFilters.product': 'Product',
    'hero.quickFilters.sales': 'Sales',
    ...
    'actions.quickApply': 'Quick Apply',
    'actions.saveJob': 'Save Job',
    'actions.retry': 'Retry',
